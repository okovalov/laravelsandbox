...
Route::get('/post/update/{id}', array('uses' => 'PostController@update', 'as' => 'get.post.update'));
Route::get('/post/delete/{id}', array('uses' => 'PostController@destroy', 'as' => 'get.post.destroy'));
